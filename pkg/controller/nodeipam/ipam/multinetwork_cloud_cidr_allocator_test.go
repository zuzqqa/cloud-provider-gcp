...
func TestDefaultNetworkCIDRs_IPv4Only(t *testing.T) {
	...
	defaultGNP := gkeNetworkParams("default", "projects/testProject/regions/us-central1/subnetworks/default", "", []string{"test-pod-range"})
	...
	sec1GNP := gkeNetworkParams("secondary1-params", "projects/testProject/regions/us-central1/subnetworks/default", "different-subnet", []string{"sec1-pod-range"})
	...
	sec2GNP := gkeNetworkParams("secondary2-params", "projects/testProject/regions/us-central1/subnetworks/other-vpc", "", []string{"sec2-pod-range"})
	...
	interfaces := []*compute.NetworkInterface{
		{
			Name:      "nic0",
			Network:   "projects/testProject/regions/us-central1/subnetworks/default",
			NetworkIP: "10.0.0.1",
			AliasIpRanges: []*compute.AliasIpRange{
				{
		...
		{
			Name:      "nic2",
			Network:   "projects/testProject/regions/us-central1/subnetworks/other-vpc",
			NetworkIP: "10.0.3.1",
		},
	}
...
func TestDefaultNetworkCIDRs_DualStack_NoLabels(t *testing.T) {
	...
	interfaces := []*compute.NetworkInterface{
		...
		{
			Name:        "nic1",
			Network:     "projects/testProject/regions/us-central1/subnetworks/secondary1",
			NetworkIP:   "10.0.2.1",
			Ipv6Address: "2001:db9:1::110", 
		},
		{
			Name:        "nic2",
			Network:     "projects/testProject/regions/us-central1/subnetworks/secondary2",
			NetworkIP:   "10.0.3.1",
		},
	}
